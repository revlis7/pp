...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('misc/resources/css/ext-all-neptune.css'); ?>" />
...
.app-header2 {
  ...
  .style_row_proj1 tr{background-color:#F9EEF2 !important;cursor: pointer;color: #2f4b52}
    /*  .x-grid-row {height:26px;vertical-align:top}
  .x-grid-cell {height:26px;vertical-align:top}
  .x-grid-cell-inner {height:26px;font-size:12px;padding:1px 6px 1px 6px;line-height:26px}
    */
  ...
  .r_ex_td_main {border-collapse:collapse;width:460px;padding:8px;border:1px solid #C1DAD7;background: #fff;color: #3f5b62;font-size:12px}
