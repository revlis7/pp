...
//    }
    ...
    var fullGridColumns=[{
      ...
      {text:'项目状态',columns:[
        ...
        {text:'销售状态',     dataIndex:'status',         filtable:true,sortable : true, width:50,style: "text-align:center;",align: 'center', 
          renderer:function(value,metaData){
            if(value=="在售"){
              metaData.style='background:#CCFFCC;color:#000000'
            }
      ...
      {text:'产品信息',columns:[
        {text:'产品等级',     dataIndex:'grade',          filtable:true,sortable : true, width:50},
        {text:'类别',       dataIndex:'sub_category',    filtable:true,sortable : true, width:150,style: "text-align:center;",align: 'left'},
        {text:'发行方',       dataIndex:'issue',         filtable:true,sortable : true, width:100,style: "text-align:center;",align: 'center'},
        ...
        {text:'产品经理',     dataIndex:'manager',        filtable:true,sortable : true, width:60, style: "text-align:center;",align: 'center'},
        {text:'合同信息',     dataIndex:'contract',        filtable:true,sortable : true, width:100, style: "text-align:center;",align: 'center',
          renderer: function(value,metaData,record,colIndex,store,view) {  
      ...
      {text:'佣金信息',columns:[
        {text:'税后佣金',     dataIndex:'commission_a_tax',  filtable:true,sortable : true, width:50, style: "text-align:center;",align: 'center',
        renderer: function(value,metaData,record,colIndex,store,view) {  
          return value+'%'; 
        }},
        {text:'佣金',         dataIndex:'inner_commission', filtable:true,sortable : true, width:50, style: "text-align:center;",align: 'center',
        renderer: function(value,metaData,record,colIndex,store,view) {  
          return value+'%'; 
        }},
        {text:'佣金（税后）', dataIndex:'outer_commission', filtable:true,sortable : true, width:50, style: "text-align:center;",align: 'center',
        renderer: function(value,metaData,record,colIndex,store,view) {  
          return value+'%'; 
        }}
      ]},
